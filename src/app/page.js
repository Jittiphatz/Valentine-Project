      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <div className={`card-container ${isFlipped ? 'opened' : ''}`} onClick={toggleCard}>
          <div className="card-front">
            ...
            <div className="text-center text-black">13 June 2024 ❤️</div>
          ...
          <div className="card-back">
            <div className="message-content">
              <h2 className="message-title">To My Love</h2>
              <p className="message-body">
                สุขสันต์วันวาเลนไทน์นะคับเธออ เค้าโชคดีที่เธอเข้ามาในชีวิตเค้า เธอทำให้ชีวิตเค้ามีความสุขมากๆในทุกๆวัน
                เค้าอยากจะบอกเธอว่า เค้ารักเธอมากๆเลยนะ ไม่มีวันไหนที่เค้าไม่รักเธอเลย เค้าสบายใจเวลาที่ได้คุยและได้อยู่กับเธอ
                เค้าอยากให้เธออยู่กับเค้าไปนานๆเลยนะ 💖🌷
              </p>
